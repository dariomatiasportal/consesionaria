...
class Tarea extends CI_Controller {
    ...
    public function tarealist()
    {
        try{
            ...
            $crud->display_as('text','Descripcion')
                 ...
                 ->display_as('end_date','Finalizacion')
                 ->display_as('text','Descripcion');
            
            $crud->set_subject('Tarea');            
            $crud->columns('mecanico','cliente','patente','vehiculo','text','estado');
            
            $crud->set_relation('mecanico','members','{fname} {lname}');
            ...
            $crud->edit_fields(array('text','start_date','end_date','mecanico','patente','vehiculo','estado','cliente'));
    ...
    public function empleados_management()
    {
            $crud = new grocery_CRUD();
            ...
            $crud->display_as('id','Documento')
                 ->display_as('fname','Nombre')
                 ->display_as('lname','Apellido')
                 ->display_as('age','Edad')
                 ->display_as('contact','Contacto')
                 ->display_as('address','Direccion');
            $crud->set_subject('Empleado');
            $crud->columns('id','fname','lname','age','contact','cargo');
